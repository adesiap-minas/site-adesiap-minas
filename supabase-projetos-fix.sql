-- =====================================================
-- ADESIAP MINAS — Setup completo de Projetos
...
CREATE TABLE IF NOT EXISTS categorias (
    ...
    cor_principal   TEXT DEFAULT '#12395D',
    cor_forte       TEXT DEFAULT '#0a2135',
    cor_clara       TEXT DEFAULT '#e7effa',
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        WHERE policyname = 'publico_select_categorias' AND tablename = 'categorias'
    ) THEN
        EXECUTE 'CREATE POLICY "publico_select_categorias" ON categorias FOR SELECT USING (ativo = TRUE)';
    END IF;
END$$;

-- ── 2. COLUNAS NOVAS EM PROJETOS ──────────────────
...
-- FK separada para não falhar se já existir
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'projetos_categoria_id_fkey'
    ) THEN
        ALTER TABLE projetos
            ADD CONSTRAINT projetos_categoria_id_fkey
            FOREIGN KEY (categoria_id) REFERENCES categorias(id);
    END IF;
END$$;

-- UNIQUE em slug separado para não falhar se já existir
DROP INDEX IF EXISTS projetos_slug_key;

DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'projetos_slug_unique'
    ) THEN
        ALTER TABLE projetos ADD CONSTRAINT projetos_slug_unique UNIQUE (slug);
    END IF;
END$$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies
        WHERE tablename = 'objects' AND schemaname = 'storage' AND policyname = 'upload_imagens_projetos'
    ) THEN
        EXECUTE 'CREATE POLICY "upload_imagens_projetos" ON storage.objects FOR INSERT WITH CHECK (bucket_id = ''imagens-projetos'')';
    END IF;
END$$;
...
BEGIN
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano, parceiros)
    VALUES ('sde-semana-desenvolvimento', 'SDE - Semana de Desenvolvimento', 'Desenvolvimento Econômico',
    ...
    ON CONFLICT ON CONSTRAINT projetos_slug_unique DO NOTHING;

    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('sde-minas', 'SDE Minas', 'Desenvolvimento Econômico',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano, parceiros)
    VALUES ('campe-atendimento-empreendedor', 'Campe – Atendimento ao Empreendedor', 'Gestão Pública',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('fnec-forum-negocios', 'FNEC – Fórum de Negócios', 'Inovação e Negócios',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('forum-diversificacao-mariana', 'Fórum de Diversificação de Mariana', 'Diversificação Econômica',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('feirao-veiculos-mariana', 'Feirão de Veículos de Mariana', 'Varejo e Consumo',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('projeto-so-por-hoje', 'Projeto Só Por Hoje', 'Saúde Pública',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('tamo-junto-qualificado', 'Tamo Junto e Qualificado', 'Capacitação',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('sos-rs-cestas', 'SOS Rio Grande do Sul – Cestas', 'Ação Humanitária',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('feirao-empregos-sedese', 'Feirão de Empregos da SEDESE', 'Empregabilidade',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('gestao-tcas-tacs', 'Gestão de TCAs e TACs', 'Meio Ambiente',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('desassoreamento-rio-itabirito', 'Desassoreamento do Rio Itabirito', 'Recuperação Ambiental',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('agir-gestao-riscos', 'AGIR – Gestão Integrada de Riscos', 'Gestão de Riscos',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('apac-itabirito', 'Projeto APAC Itabirito', 'Infraestrutura Social',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('ubs-ouro-branco', 'Construção de UBS - Ouro Branco', 'Saúde Pública',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('laboratorio-subterraneo-ufla', 'Laboratório Subterrâneo – UFLA', 'Pesquisa e Inovação',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('sos-rs-habitacional', 'SOS RS – Unidades Habitacionais', 'Habitação',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('tac-pavimentacao', 'TAC Pavimentação', 'Mobilidade Urbana',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('ponte-rio-grande-do-sul', 'Ponte – Rio Grande do Sul', 'Infraestrutura Viária',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('calcadao-divinopolis', 'Calçadão de Divinópolis', 'Urbanismo',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('natal-nova-lima', 'Natal de Nova Lima', 'Eventos Culturais',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('festival-batata-ouro-branco', 'Festival da Batata – Ouro Branco', 'Turismo e Entretenimento',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('ceramica-saramenha', 'Cerâmica Saramenha', 'Patrimônio Imaterial',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('carnaval-itabirito', 'Decoração Carnaval de Itabirito', 'Cultura Popular',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('carnaval-mariana', 'Carnaval de Mariana', 'Eventos Festivos',
    ...
    INSERT INTO projetos (slug, titulo, subtag, resumo, categoria, categoria_id, ods, imagem_url, publicado, destaque, ordem, local, ano)
    VALUES ('corrida-so-por-hoje', 'Corrida Só Por Hoje', 'Esporte e Saúde',
...
SELECT COUNT(*) AS total_projetos    FROM projetos WHERE slug IS NOT NULL;
